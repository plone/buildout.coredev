...
- [ ] Check that the version numbers of [`CMFPlone metadata.xml`](https://github.com/plone/Products.CMFPlone/blob/6.1.x/Products/CMFPlone/profiles/default/metadata.xml) and latest [`upgrade step`](https://github.com/plone/plone.app.upgrade/blob/3.x/src/plone/app/upgrade/v61/configure.zcml) are in sync, and that they are higher than in the previous Plone release.
