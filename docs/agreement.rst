...
If they're listed in either the `Developers <https://github.com/orgs/plone/teams/developers/members>`_ or `Contributors <https://github.com/orgs/plone/teams/contributors/members>`_ team, the author has signed the Plone Contributor Agreement, so we can go ahead and merge.
